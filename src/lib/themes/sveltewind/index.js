...
export default {
    ...
    dataTableToolbar:
        'flex flex-row rounded-none rounded-t items-center justify-end py-3 px-3 space-x-3 shadow-none dark:shadow-none',
    dataTableTh:
        'cursor-pointer transition duration-200 hover:bg-violet-50 dark:hover:bg-violet-950',
    dataTableType: twMerge(
        inputBaseClasses,
        'ring-0 dark:ring-0 ring-offset-0 rounded-none'
    ),
    drawer: 'fixed transition duration-200 bg-white dark:bg-white/25',
    ...
    header:
        'flex justify-end ring-1 ring-black/10 lg:flex-col lg:justify-start dark:ring-white/5',
    icon: 'h-6 w-6',
