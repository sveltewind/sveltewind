...
export default {
  ...
  dataTableTh: 'cursor-pointer transition duration-200 hover:bg-blue-50 dark:hover:bg-blue-950',
  dataTableType: twMerge(inputBaseClasses, 'ring-0 dark:ring-0 ring-offset-0 rounded-none'),
  ...
  overlay: 'absolute top-0 left-0 h-full w-[100dvw] h-[100dvh] bg-black/70 transition duration-200',
